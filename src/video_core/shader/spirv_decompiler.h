...
struct DeviceSettings {
    ...
    bool IsWarpSizePotentiallyBiggerThanGuest;
    bool IsGuestWarpSizeSupported;
    bool IsFormatlessImageLoadSupported;
    bool IsNvViewportSwizzleSupported;
    bool IsKhrUniformBufferStandardLayoutSupported;
    bool IsExtIndexTypeUint8Supported;
    bool IsExtDepthRangeUnrestrictedSupported;
    bool IsExtShaderViewportIndexLayerSupported;
    bool IsExtTransformFeedbackSupported;
    bool IsExtCustomBorderColorSupported;
    bool IsExtExtendedDynamicStateSupported;
};
...
struct Specialization final {
    ...
    std::vector<u8> custom_input_varyings{};
...
std::vector<u32> Decompile(const DeviceSettings& deviceSettings, const VideoCommon::Shader::ShaderIR& ir,
